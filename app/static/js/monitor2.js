/* === ESP32 Monitor V2 ===
   Копія monitor.js. Слухає окремі типи повідомлень (registration_status_v2,
   esp32_data_v2), щоб не конфліктувати зі старим монітором (/monitor). */
